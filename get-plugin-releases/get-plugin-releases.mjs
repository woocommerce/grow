...
var semverValid = /*@__PURE__*/getDefaultExportFromCjs(validExports);
...
var rcompareExports = requireRcompare();
var semverRcompare = /*@__PURE__*/getDefaultExportFromCjs(rcompareExports);
...
var semverPrerelease = /*@__PURE__*/getDefaultExportFromCjs(prereleaseExports);
...
var semverCoerce = /*@__PURE__*/getDefaultExportFromCjs(coerceExports);
...
function parsePluginVersions( data, inputs ) {
...
if ( process.env.GITHUB_ACTIONS ) {
	...
	getPluginReleases( inputs )
		.then( ( versions ) => {
			info( `==> Output "versions":\n${ versions }` );
			setOutput( 'versions', versions );
			info( 'Finish getting the release versions.' );
		} )
		.catch( handleActionErrors );
}

export { parsePluginVersions };
